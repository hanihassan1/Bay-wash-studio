...
def send_mail(username, email):
    ...
    msg.html="""<img src="static/img/baywayshlogo.png"><p><b style="color:gold">You're booked!</b></p><p>Your appointment is on: <b><i>{}</i></b>.</p> <p>Your Time is:<b><i>{}</i></b>.</p>""".format(request.form['date'],
    request.form['time'])
    mail.send(msg)
